...
class TrayContentsNode(Node):
    def __init__(self) -> None:
        super().__init__("tray_contents_node")

        self.declare_parameter("detections_topic", "/detections")
        self.declare_parameter("image_topic", "/zed/zed_node/rgb/image_rect_color")
        self.declare_parameter("tray_contents_topic", "/perception/tray_contents")
        self.declare_parameter("tray_model_path", default_tray_model_path())
        ...
        self.get_logger().info(
            f"TrayContentsNode ready. detections_topic={detections_topic}, "
