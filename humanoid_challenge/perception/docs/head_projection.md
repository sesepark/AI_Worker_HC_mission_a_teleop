...
담당하는 ROS 2 노드입니다. `perception`(YOLO)의 출력을 받아
...
# 또는 따로따로
ros2 launch perception head_projection.launch.py   # target_pose만
ros2 launch perception head_pointcloud.launch.py    # mask_cloud만
ros2 launch perception head_grasp_pcd.launch.py     # 객체별 정제 PCD (핵심)
```
