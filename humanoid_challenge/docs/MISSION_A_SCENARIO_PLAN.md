...
│   ├── perception/              # A.2 부품 검출·분류 (YOLO11s-seg)
│   ├── perception/            # A.3 wrist 2D→3D 변환
│   ├── perception/                  # head 카메라 2D→3D (참고용)
│   ├── tray_occupancy/                       # 트레이 검출 + 잔여 task 관리
...
> **🟢 Phase 1 진행 기록 (2026-05-31)**: tray_occupancy 추가 반영. mission_a 가 `/perception/task_list`
