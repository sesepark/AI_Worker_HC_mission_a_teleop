...
>
> **🆕 tray_occupancy 패키지 추가 (upstream `demo/senario_A`)**: 트레이 검출(`tray_occupancy_node`) +
...
| 코드 | 팀 | 상태 |
|------|----|------|
| `tray_occupancy_node` (tray_occupancy) | Perception | ✅ 구현 (`demo/senario_A`) — `/perception/tray_contents` |
