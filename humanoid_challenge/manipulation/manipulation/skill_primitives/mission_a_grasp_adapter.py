...
# yaw90 approach 오프셋
GRASP_YAW_X_OFFSET = -0.038  # m — x 진입 조정 (실측 후 수정, 예: -0.043 / -0.045)
GRASP_YAW_Y_OFFSET = 0.003   # m — y 미세 조정 (실측 후 수정, 예: 0.043)

GRASP_Z         = 0.830    # m — 고정 파지 높이
#-0.04, -0.15
# ── 근접 판단 상수 ────────────────────────────────────────────────────
NEIGHBOR_CLOSE_THRESH = 0.110   # m — 이 이내면 붙어있다고 판단 (너트 중앙 간격 기준)
