...
Usage:
  ros2 run manipulation move_to_pose X Y Z [QX QY QZ QW]

  X Y Z          — position in base_link frame (metres)
  QX QY QZ QW    — orientation quaternion (optional, defaults to identity)

Examples:
  ros2 run manipulation move_to_pose 0.4 -0.2 0.9
  ros2 run manipulation move_to_pose 0.4 -0.2 0.9 0.0 0.0 0.0 1.0
"""
