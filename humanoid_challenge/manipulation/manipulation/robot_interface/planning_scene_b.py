...
def _lookup_base_to_odom(node):
    ...
    node.get_logger().warn('[planning_scene_b] odom→base_link TF lookup 타임아웃, base_link 좌표 그대로 사용')
    return None
...
ZONE_B_CONFIG_PATH = os.path.join(PACKAGE_SHARE_DIR, "config", "zone_b.yaml")
