...
> **현재 상태**: `~/robotis_ros2_ws/` 가 root 소유, `save_image.py` 1개만 있음 (불필요)
...
pip install paddlepaddle paddleocr ultralytics opencv-python numpy
deactivate
...
deactivate
```
⚠️ 정확한 패키지 목록은 Perception 팀 확인 필요. 위는 추정치.
